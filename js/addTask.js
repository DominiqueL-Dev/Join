...
function setPriority(priority) {
  ...
  urgentImg.src = '/join/assets/icons/urgentRed.png';
  mediumImg.src = '/join/assets/icons/mediumYellow.png';
  lowImg.src = '/join/assets/icons/lowGreen.png';
...
function btnPriority(priority) {
  if (priority === 'urgent') {
    ...
    urgentImg.src = '/join/assets/icons/urgentWhite.png';
  } else if (priority === 'medium') {
    prioMediumEdit.classList.add('prioMediumYellow');
    mediumImg.src = '/join/assets/icons/mediumWhite.png';
  } else if (priority === 'low') {
    prioLowEdit.classList.add('prioLowGreen');
    lowImg.src = '/join/assets/icons/lowWhite.png';
  }
}
