...
function addNewContactPopup() {
    ...
    <div class="add-edit-popup-contact-div">
      <div class="popup-left">
        <img src="/join/assets/img/logohell.png" alt="" />
        <h1>Add contact</h1>
      ...
      <div class="popup-right">
        <div>
          <img src="/join/assets/img/profileIMG.png" alt="" />
        </div>
        <div>
          <img
            class="popup-close-img"
            onclick="closePopUp()"
            src="/join/assets/icons/close.png"
            alt=""
          />
        </div>
        <div>
          ...
          <div class="popup-buttons">
            <button class="cancel-button" onclick="closePopUp()">
              Cancel <img src="/join/assets/icons/cancel.png" alt="" />
            </button>
            <button class="create-button" onclick="saveContact()">
              Create contact <img src="/join/assets/icons/check.png" alt="" />
            </button>
          </div>
        </div>
      </div>
  ...
  function mobileAddNewContactPopup() {
    ...
    <div>
          <img
            ...
            onclick="closePopUp()"
            src="/join/assets/icons/close-white.png"
            alt=""
          />
        </div>
        ...
        <div>
          ...
          <div class="popup-buttons">
            ...
            <button class="create-button" onclick="updateContact()">
              Save <img src="/join/assets/icons/check.png" alt="" />
            </button>
          </div>
        </div>
      </div>
