...
function renderAddTaskPoupBtn() {
  ...
  <div class="add-edit-popup-task-div">
    ...
    <div class="addTaskClose"><img onclick="closeAddTaskPopUp()" src="/join/assets/icons/close.png" alt=""></div>
        ...
        <form onsubmit="return false">
            ...
            <section class="formPartRight">
              ...
              <section id="prio" class="prioContent">
                <button type="button" id="prioUrgentEdit" class="prioBtn" onclick="prioUrgent()">
                  Urgent
                  <img id="urgentImg" src="/join/assets/icons/urgentRed.png" alt="" />
                </button>
                <button type="button" id="prioMediumEdit" class="prioBtn" onclick="prioMedium()">
                  Medium
                  <img id="mediumImg" src="/join/assets/icons/mediumYellow.png" alt="" />
                </button>
                <button type="button" id="prioLowEdit" class="prioBtn" onclick="prioLow()">
                  Low <img id="lowImg" src="/join/assets/icons/lowGreen.png" alt="" />
                </button>
              </section>
              <br />
              ...
              <div onclick="categorytList()" class="categoryContainer" id="category">
                ...
                <img id="categoryArrowDown" src="/join/assets/icons/arrow_drop_down.png" alt="" />
                <img id="categoryArrowUp" class="d-none" src="/join/assets/icons/arrow_drop_up.png" alt="" />
          ...
          <div class="taskFormButtons">
            ...
            <div class="btnSection">
              <button type="reset" class="clearBtn" onclick="clearForm()">Clear <img src="/join/assets/icons/cancel.png" alt="" /></button>
              <button type="button" onclick="createTaskBtn()" class="button">
                Create Task <img src="/join/assets/icons/check.png" alt="" />
              </button>
            </div>
          </div>
        </form>
  ...
  <div class="add-edit-popup-task-div">
    <div class="addTaskContent">
    <div class="addTaskClose"><img onclick="closeAddTaskPopUpToDo()" src="/join/assets/icons/close.png" alt=""></div>
        <div class="headlineDiv"><h1>Add Task</h1></div>
        <form onsubmit="return false">
          <div class="formParts">
            <section class="formPartLeft">
          ...
          <div class="taskFormButtons">
            ...
            <div class="btnSection">
              <button type="reset" class="clearBtn">Clear <img src="/join/assets/icons/cancel.png" alt="" /></button>
  ...
  <div class="add-edit-popup-task-div">
    <div class="addTaskContent">
    <div class="addTaskClose"><img onclick="closeAddTaskPopUpInProgress()" src="/join/assets/icons/close.png" alt=""></div>
        <div class="headlineDiv"><h1>Add Task</h1></div>
        <form onsubmit="return false">
          <div class="formParts">
            <section class="formPartLeft">
  ...
  <div class="add-edit-popup-task-div">
    <div class="addTaskContent">
    <div class="addTaskClose"><img onclick="closeAddTaskPopUpAwaitFeedback()" src="/join/assets/icons/close.png" alt=""></div>
        <div class="headlineDiv"><h1>Add Task</h1></div>
        <form onsubmit="return false">
          <div class="formParts">
            <section class="formPartLeft">
