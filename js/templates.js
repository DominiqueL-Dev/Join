...
function renderTasksCardPopup(task) {
  ...
  let priorityImageSrc = `/join/assets/icons/${
  ...
  <div class="shadow-div"></div>
    <div class="taskCardPopup" id="taskPopUp" data-task-id="${task.id}">
      <div class="taskCardPopupCategory">
        ...
        <img onclick="closeTaskCardPopUp()" src="/join/assets/icons/close.png" alt="" />
      </div>
    ...
    <label class="taskCardPopupLabel">Subtasks</label>
      ...
      <div class="taskCardPopupButtons">
        <div onclick="deleteTask('${task.id}')">
          <img src="/join/assets/icons/deleteContact.png" alt="">Delete
        </div>
        <hr class="hrBoardTaskPopUp">
        <div onclick="openEditTaskPopup('${task.id}')">
          <img src="/join/assets/icons/edit-pencil.png" alt="">Edit
        </div>
      </div>
    </div>
  `;
    ...
    <div class="taskCardEditPopup">
      <div class="task-edit-close-popup-div">
        <div class="closeImgContent">
          <img onclick="closeEditTaskCardPopUp()" class="task-edit-close-popup" src="/join/assets/icons/close.png" alt=""/>
        </div>
      </div>
      ...
      ? "/join/assets/icons/urgentWhite.png"
      : "/join/assets/icons/urgentRed.png"}" alt="" />
        </button>
      ...
      ? "/join/assets/icons/mediumWhite.png"
      : "/join/assets/icons/mediumYellow.png"}" alt="" />
        </button>
      ...
      ? "/join/assets/icons/lowWhite.png"
      : "/join/assets/icons/lowGreen.png"}" alt="" />
        </button>
      </div>
      ...
      <div>
        <div onclick="contactListPopUp()" class="assignedContainer">
          ...
          <img id="assignedArrowDown" src="/join/assets/icons/arrow_drop_down.png" alt="" />
          <img id="assignedArrowUp" class="d-none" src="/join/assets/icons/arrow_drop_up.png" alt="" />
        </div>
      ...
      <div id="addSubTask">
        ...
        <img onclick="addSubTaskPopUp()" style="cursor: pointer" src="/join/assets/icons/Subtasks_plus.png" alt="" />
      </div>
      <ul id="subTaskList">
        ${subTasks
      .map(
          ...
          <li class="subTask" data-index="${i}">
            ...
            <div class="subTask-actions">
              <div class="icon-wrapper">
                <img id="subEditImgPen-${i}" src="/join/assets/icons/edit-icon.png" alt="Edit" onclick="editSubTask(${i})" class="action-icon edit-icon">
              </div>
              <div class="icon-wrapper">
                <img src="/join/assets/icons/delete-icon.png" alt="Delete" onclick="deleteSubTask(${i})" class="action-icon delete-icon">
              </div>
              <div class="separator"></div>
              <div class="icon-wrapper">
                <img id="subEditImgCheck-${i}" src="/join/assets/icons/checkBgWhite.png" alt="Save" onclick="saveSubTask(${i})" class="action-icon save-icon d-none">
              </div>
            </div>
          </li>
        `
      ...
      <div class="button-ok-div">
        ...
        <button onclick="updateEditTask(event)" data-task-id="${taskId}" class="button-ok">Ok <img src="/join/assets/icons/check.png" alt="" /></button>
        </div>
      </div>
    </div>
  `;
...
function updatePriority(newPriority) {
  ...
  const priorityStyles = {
    Urgent: {class: "prioUrgentRed",imgSrc: "/join/assets/icons/urgentWhite.png",},
    Medium: {class: "prioMediumYellow",imgSrc: "/join/assets/icons/mediumWhite.png",},
    Low: {class: "prioLowGreen",imgSrc: "/join/assets/icons/lowWhite.png",},
  };
  ...
  document.getElementById("prioUrgentEditPopup").querySelector("img").src = "/join/assets/icons/urgentRed.png";
  document.getElementById("prioMediumEditPopup").querySelector("img").src = "/join/assets/icons/mediumYellow.png";
  document.getElementById("prioLowEditPopup").querySelector("img").src = "/join/assets/icons/lowGreen.png";
    ...
    <div class="task-card-div">
      <div class="task-card-category-div">
        ...
        <img class="move-img-up" onclick="moveTaskToNextColumn('${
          task.id
        }', -1, event)" src="/join/assets/icons/arrow-left-line.png" alt="">
